...
if (!Function.prototype.bind) {
    ...
    {
        var func = this;
        return function(...args) { return func.apply(obj, args); };
    };
}
...
Strophe.Connection.prototype = {
     ...
     */
    connect(jid, pass, callback, wait, hold) {
        this.jid = jid;
        this.pass = pass;
